...
function histogram(data, opts) {
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    /*
     * If the value is 0 then don't display any bar char
     * This prevents a bug where a 0 value would fill the entire bar
     *
     * This can be solved in a more elegant way, but this will do for now
     */
    if (d.val === 0) {
      bar = Array(shown + 1).join(' ');
    }
